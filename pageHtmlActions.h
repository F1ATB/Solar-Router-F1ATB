...
function TracePlanning(iAct) {
  ...
  S +="<div class='Tcell1'>Coef. Intégral ou Réactivité </div>";
...
function infoZclicK(i, iAct) {
    ...
    if (!blockEvent) {
        ...
        var S = "<div class='selectZ'> Sélection Action<div class='closeZ' onclick='infoZclose(\"" + idZ + "\")'>X</div></div>";
...
function Disp(t) {
  if ( t!="zOn" && t!="zOff" && t!="pwTr" && t!="mxTr"  && t!="tmpr" && t!="tarif"  && t!="sAct" ) t=t.id.substr(0, 4);
    ...
    switch (t) { 
    case "mode":
        m = "Désactivation du routage ou mode de découpe du secteur 230V.";
        break;
    case "opti":
    ...
    case "titr":
        ...
        break;
    case "slid":
        m = "Gain de la boucle d'asservissement:  Proportionnel, Intégral, Dérivé. A ajuster suivant la charge branchée.";
        break;
    case "host":
        m = "Adresse IP machine sur réseau LAN, nom de domaine ou rien pour l'ESP32.<br />Ex : <b>192.168.1.25</b> ou <b>machine.local</b> .";
        break;
    case "port":
        m = "Port d'accès via le protocole http , uniquement pour machine distante. En général <b>80</b>.";
        break;
    case "ordr":
        m = "Ordre à passer à la machine distante. <br />";
        m += "Ex. pour une machine sur le réseau :<br /><b>/commande?idx=23&position=on</b>. Se référer &agrave; la documentation constructeur.";
        break;
    case "sele":
        ...
        break;
    case "repe":
        m = "Période en s de répétition/rafra&icirc;chissement de la commande. Uniquement pour les commandes vers l'extérieur.<br />";
    ...
    case "temp":
        ...
        break;
    case "adds":
        m = "Ajout ou retrait d'une période horaire.";
        break;
    case "Pw_m":
        m = "Seuil de puissance pour activer ou désactiver le routage.";
        m +="Attention, en cas de mode On/Off la différence, seuil supérieur moins  seuil inférieur doit &ecirc;tre supérieure &agrave; la consommation du dipositif pour éviter l'oscillation du relais de commande.";
        break;
    case "pwTr":
        m = "Seuil en W de régulation par le Triac de la puissance mesurée Pw en entrée de la maison. Valeur typique : 0.";
        break;
    case "mxTr":
