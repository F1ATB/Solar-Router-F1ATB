...
<html>
  ...
  <body onload='Init();' >
    ...
    <br /><br /><div class='foot' >Données  RMS<div id='source'></div></div>
...
function EtatActions(Force,NumAction) {
  ...
  xhttp.onreadystatechange = function() { 
    if (this.readyState == 4) {
      ...
      myActionTimeout = setTimeout(EtatActions, 3500, 0, 0);
    }
  };
...
//Rafraichit exactement toutes les 2s les graphiques de 10mn avec les dernieres valeur connues
function Refresh_2s() { 
