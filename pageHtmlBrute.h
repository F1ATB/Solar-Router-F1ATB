...
<html>
  ...
  <body onload="SetHautBas();LoadParaRouteur();">
    ...
    <div id="infoNotDef">
      <div class="tableau">
        Source des mesures de puissance non définie<br />A définir au bas de la page Paramètres<br /><br />Données simulées
      </div>
      <br /><br />
    </div>
    <div id="infoUxI">
...
L.push(['EASF01','Energie active soutirée Fournisseur,<br />index 01',true,'Wh',0]);
L.push(['EASF02','Energie active soutirée Fournisseur,<br />index 02',true,'Wh',0]);
L.push(['EASF03','Energie active soutirée Fournisseur,<br />index 03',true,'Wh',0]);
L.push(['EASF04','Energie active soutirée Fournisseur,<br />index 04',true,'Wh',0]);
L.push(['EASF05','Energie active soutirée Fournisseur,<br />index 05',true,'Wh',0]);
L.push(['EASF06','Energie active soutirée Fournisseur,<br />index 06',true,'Wh',0]);
L.push(['EASF07','Energie active soutirée Fournisseur,<br />index 07',true,'Wh',0]);
L.push(['EASF08','Energie active soutirée Fournisseur,<br />index 08',true,'Wh',0]);
L.push(['EASF09','Energie active soutirée Fournisseur,<br />index 09',true,'Wh',0]);
L.push(['EASF10','Energie active soutirée Fournisseur,<br />index 10',true,'Wh',0]);
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4) {
      if (this.status == 200) {
        ...
        var LaSource = Source;
        if (LaSource == 'Ext') {
          LaSource = 'Externe (' + Source_data + ')<br />' + int2ip(RMSextIP);
        }
        ...
        if (ModeReseau < 2) {
          if (message[1] < 10) {
            ...
            S += '<tr><td>Point d\'accès WiFi :</td><td>' + message[3] + '</td></tr>';
            S += '<tr><td>Réseau WiFi :</td><td>' + message[6] + '</td></tr>';
          ...
          S += '<tr><td>Masque du réseau :</td><td>' + message[9] + '</td></tr>';
        } else {
        ...
        if (message[17] > 0) {
          Stemp += '<span class="fsize10">' + message[18] + '</span>';
        }
    ...
    if (this.readyState == 4) {
      if (this.status == 200) {
        ...
        if (Source_data == 'UxI') {
          ...
          S += '<polyline points="';
          for (var i = 0; i < 100; i++) {
            var Y = 197 - (185 * volt[i]) / Vmax;if (message[17]>0)
            var X = 10 * i;
            S += X + ',' + Y + ' ';
          }
